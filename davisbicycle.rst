...
9.1<figSurly>`. It is designed as a single-speed off-road bicycle for 26"
...
with respect to the rear frame, :ref:`Figure 9.2<figRigidHarness>`. A medical
...
9.3<figKneeRestraints>`. Chapters :ref:`delftbicycle` and :ref:`motioncapture`
...
9.4<figRestrictedHarness>`. The plan was to attach the hip brace to the
...
9.1<tabKinematicSensors>` gives general ranges of bicycle kinematic motions
...
I designed a simple trailer, :ref:`Figure 9.5<figRollTrailer>`, that was pulled
...
ground as possible. :ref:`Figure 9.6<figTrailerAngle>` shows how the yoke pitch
...
:ref:`Figure 9.7<figSteerSensors>`: a potentiometer for relative steering angle
...
9.8<figSpeedometer>`. A small knurled aluminum disc on the motor shaft engaged
...
:ref:`Table 9.2<tabFinalSensors>` gives the characteristics of the final choice
in sensors.
...
the seat via a ball joint, :ref:`Figure 9.9<figLateralForceStick>`. The ball
...
9.10<figPerturbation>` gives an example perturbation measurement during a
treadmill run.
...
easier detachment, :ref:`Figure 9.11<figFootPeg>`. Each foot peg was fit with
...
:cite:`Cheng2003`
   ...
   9.12<figCheng>`, which reduced the effects of other moments and forces
...
:cite:`Eaton1973`
   ...
   handlebar, :ref:`Figure 9.13<figEatonSteerTorque>` and had the rider control
...
:cite:`Weir1979a`
   ...
   multiple motorcycles, :ref:`Figure 9.14<figWeirSteerTorque>`. The range was
...
:cite:`Biral2003`
   ...
   motorcycle using a cantilever beam, :ref:`Figure 9.15<figBiralSteerTorque>`.
...
9.16<figTorqueWrenchMount>`. A helmet camera was mounted to the bicycle such
that it could view the torque wrench, handlebars and speedometer relative to
the bicycle frame, :ref:`Figure 9.17<figTorqueWrenchCamera>`. The torque
...
measurements, :ref:`Figure 9.18<figTorqueWrenchFace>`. The bicycle speed was
...
9.19<figTwrenchTorqueHistogram>`, shows that we never recorded any torques
higher than 5 Nm and table :ref:`Table 9.3<tabTorqueManeuver>` gives the
maximum and minimum torques for each maneuver. :ref:`Figure
9.20<figTwrenchTorqueSpeed>` shows all of the recorded torques as a function
...
compression. :ref:`Figure 9.21<figBicycleForces>` shows the free body diagram
...
.. figure:: figures/davisbicycle/beam.*
   ...
   9.21<figBicycleForces>`. The headset bearings at C and D are assumed to not
   resist moments.

The following graph, :ref:`Figure 9.23<figForkLoad>`, shows what the shear and
...
:ref:`Figure 9.24<figSteerTorqueDesign>`.
...
:ref:`Figure 9.25<figHandlebarFreeBody>`. The torques acting on the handlebar
...
:eq:`eqSteerTorque`. :ref:`Figure 9.27<figSteerTorqueComponents>` gives a
...
steer tube of the fork, :ref:`Figure 9.28<figSteerAngleCalibration>` and
...
sweep of angles, :ref:`Figure 9.29<figRollAngleCalibration>`. I also took static
...
voltage for a sweep of motor rotational speeds. :ref:`Table 9.4<tabTachData>`
gives the calibration data and :ref:`Figure 9.30<figSpeedRegression>` shows
...
.. figure:: figures/davisbicycle/speed-calibration.*
   ...
   in :ref:`Table 9.4<tabTachData>`. Generated by
...
:ref:`Figure 9.31<figLoadCellCalibration>`.
...
:ref:`9.5<tabClockwise>` and :ref:`9.6<tabCounterClockwise>` give the factory
reported data and :ref:`Figure 9.32<figTorqueRegression>` shows the regression
results.
...
.. figure:: figures/davisbicycle/torque-calibration.*
   ...
   in Tables :ref:`9.5<tabClockwise>` and :ref:`9.6<tabCounterClockwise>`.
...
9.33<figLaptop>`. The devices were controlled and the data logged using Matlab.
...
after the run, :ref:`Figure 9.34<figDAQGUI>`. The general features are as
follows:
...
the floor at the beginning of the track, :ref:`Figure 9.35<figBump>`  and also
...
:ref:`Figure 9.37<figUnsync>` shows the two independent recorded events.
