...
riderless uncontrolled bicycle [Kooijman2006]_, [Kooijman2008]_,
[Kooijman2009]_, [Stevens2009]_, [Escalona2011]_ for speeds in and around the
...
:ref:`Figure 2 <figLatForceBode>` shows the frequency response in a similar
...
:ref:`Figure 3 <figArmModel>`. The arms are assumed to symmetric with respect
...
a bicycle without gyroscopic effects can be stable [Kooijman2011]_ and
...
learn to ride more easily, due to the bicycle's increased stability at low speeds
[GyroBike2011]_. I was given an article about the bicycle from the Dartmouth
alumni magazine, subsequently met the woman who created the startup company around
...
and :ref:`13 <figGyroVaryRider>` show how adjusting the flywheel angular
velocity can affect the stability of the bicycle which may be beneficial for
people learning to ride a bicycle. All of the plots were generated using
parameters measured from a production GyroBike and the rider's parameters were
generated by scaling the Yeadon geometry of an adult, Charlie, to child-size
proportions which are detailed in Chapter :ref:`physicalparameters`.
...
rider is only about 1 m/s greater than without a rider. :ref:`Figure 13
...
are taken from [Lorenzo1996]_, which he estimated to be, :math:`k_9=128`
...
and Hubbard [Lorenzo1996]_ which explored parameter studies of a model similar
...
has become unstable for all velocities and no stable speed range is present.
Additionally, the rider modes are all complex at all speeds.
...
observed by Limebeer and Sharp [Limebeer2006]_. Furthermore, another unstable
