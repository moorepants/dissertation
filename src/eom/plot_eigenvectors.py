...
for i, f in enumerate(figs):
    ...
    f.savefig('../../figures/eom/eVec' + speed + '-' + str(i + 1) + '.pdf')
figPath = '../../figures/eom/'
...
#os.system('montage -geometry +0+0 {0}eVecHalf-1.pdf {0}eVecHalf-2.pdf {0}eVecHalf-3.pdf {0}eVecHalf-4.pdf {0}eVecHalf.pdf'.format(figPath))
...
#os.system('montage -geometry +0+0 {0}eVecThree-1.pdf {0}eVecThree-2.pdf {0}eVecThree-3.pdf {0}eVecThree.pdf'.format(figPath))
...
#os.system('montage -geometry +0+0 {0}eVecSeven-1.pdf {0}eVecSeven-2.pdf {0}eVecSeven-3.pdf {0}eVecSeven.pdf'.format(figPath))
