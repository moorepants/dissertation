...
# local dependencies
sys.path.append('/media/Data/Documents/School/UC Davis/Bicycle Mechanics/AutolevToolKit')
...
gyro = bp.Bicycle('Gyro', pathToData)
...
moorePar['mg'] = benchmarkPar['mF']
moorePar['ig11'] = benchmarkPar['IFxx']
moorePar['ig22'] = benchmarkPar['IFyy']
